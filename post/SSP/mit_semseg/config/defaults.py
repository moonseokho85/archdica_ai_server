...
# weights to finetune unet
_C.MODEL.weights_unet = ""
# number of feature channels between encoder and decoder
_C.MODEL.fc_dim = 2048
# object index what you want to change
_C.MODEL.object_index = 0
...
# isolate unet weight loader
_C.TRAIN.load_unet = True
